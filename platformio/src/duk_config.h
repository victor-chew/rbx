...
#define DUK_ANSI_REALLOC rbx_realloc
...
extern duk_double_t rbx_get_now(void);
#define DUK_USE_DATE_GET_LOCAL_TZOFFSET(d) 0
#define DUK_USE_DATE_GET_NOW(ctx) rbx_get_now()
...
extern duk_bool_t rbx_timeout_check(void *udata);
#define DUK_USE_EXEC_TIMEOUT_CHECK(x) rbx_timeout_check(x)
